...
// Iterate through picArray to create articles
picArray.forEach((item) => {
  // Create the article element and assign the class 'card'
  let article = document.createElement('article');
  article.className = 'card';

  // Create and populate the heading
  ...
  // Create and populate the paragraph element
  let paragraph = document.createElement('p');
  paragraph.textContent = item.description;

  // Assemble the article: append heading, figure, and paragraph
